    ...
    <div class="container">
      ...
      <div class="student" id="student">
        ...
        <form class="" action="" method="post">
          ...
          <input type="submit" name="delete_student" value="Remove">
        ...
        <?php
          ...
          if($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['delete_student']))
          {
            ...
            if(mysqli_num_rows($result) == 1)
            {
              ...
              if($result)
              {
                echo "<script> alert('Student deleted successfully!'); window.location = 'admin-page.php'; </script>";
              }
              else
              {
                echo "<script> alert('Something went wrong!'); window.location = 'admin-page.php'; </script>";
      ...
      <div class="team" id="team">
        ...
        <h2>Remove a Core Member</h2>

        <!-- REMOVE TEAM MEMBER FORM  -->
        <form class="" action="" method="post">

          <label> Select Member ID: </label>
          <input type="number" name="core_id" value="" required><br>
          <input type="submit" name="delete_core_member" value="Remove">
